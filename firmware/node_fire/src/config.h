/**
 * Disaster Sentinel — Node 3 (Fire) Configuration
 * 
 * ESP32 Node FIR3:
 *   - Layer 1: Flame/IR Sensor (KY-026)
 *   - Layer 2: Smoke/Gas Sensor (MQ-2)
 *   - Layer 3: BME280 (Temperature spike & Humidity drop)
 */
...
// 3-Layer Weights
#define FIRE_LAYER1_WEIGHT  0.50f   // Flame IR
#define FIRE_LAYER2_WEIGHT  0.30f   // Smoke/Gas
#define FIRE_LAYER3_WEIGHT  0.20f   // BME280 Temp/Humidity
